  ...
  return (
    <section className="settingsSection">
      <form className="card settingsGrid" onSubmit={handleSubmit}>
        <div className="settingsHeaderRow">
          <div className="resourceBody">
            ...
            <span className="muted">Accounts represent where money lives and what balances should be tracked.</span>
          </div>
        </div>
      ...
      <div className="resourceList">
        {loading ? <div className="card muted">Loading accounts...</div> : null}
        {!loading && accounts.length === 0 ? (
          <div className="card muted">No accounts yet. Create one above to start tracking balances.</div>
        ) : null}
        {accounts.map((account) => (
          <div key={account.id} className="card resourceRow">
            <div className="resourceBody">
