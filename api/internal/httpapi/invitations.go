	...
	err = s.mailer.send(r.Context(), outgoing{
		...
		Document: appmail.Document{
			...
			Blocks: []appmail.Block{
				appmail.Paragraph("You have been added to the Inscribed Expenses beta. It is a personal money tracker for everyday Zambian finances — bank accounts, mobile money, savings, debts and investments."),
				appmail.Paragraph("Set a password to open your account. The premium plan is included for " + describeMonths(months) + ", counted from the day you accept."),
				appmail.Button{Label: "Set your password", URL: link},
				appmail.Paragraph("This link expires in 14 days. If you were not expecting it, you can ignore this email and nothing will be created."),
			},
